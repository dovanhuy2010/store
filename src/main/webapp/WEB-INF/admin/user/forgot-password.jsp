...
<!-- Mirrored from pixinvent.com/demo/vuexy-html-bootstrap-admin-template/html/ltr/vertical-menu-template/page-auth-forgot-password-v1.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 25 Aug 2021 02:09:57 GMT -->
<head>
        ...
        <div class="content-body">
            <div class="auth-wrapper auth-v1 px-2">
                <div class="auth-inner py-2">
                    ...
                    <div class="card mb-0" id="form-forgot-email">
                        <div class="card-body">
                            ...
                            <button id="btn-verification" class="btn btn-primary w-100" tabindex="2">Send reset link
                            </button>
                            <%--                            </form>--%>

                            <p class="text-center mt-2">
                                <a href="<c:url value="/_admin/login"/>"> <i data-feather="chevron-left"></i> Back to
                                    login
                                </a>
                            </p>
                        </div>
                    ...
                    <div class="card mb-0 hidden" id="form-check">
                        <div class="card-body">
                            <a href="#" class="brand-logo">
                                <svg
                                        viewbox="0 0 139 95"
                            ...
                            <h4 class="card-title mb-1">Verification</h4>
                            ...
                            <div class="invalid-feedback" style="display: block;"></div>
                            <button class="btn btn-primary w-100" tabindex="2" id="send-verification">Send
                                verification
                            </button>
                            <%--                            </form>--%>

                            <p class="text-center mt-2">
                                <a id="btn-back-send-mail"> <i data-feather="chevron-left"></i> Back to send email
                                </a>
                            </p>
                        </div>
                    </div>
                    ...
                    <!-- Reset Password v1 -->
                    <div class="card mb-0 hidden" id="reset-password-form">
                        <div class="card-body">
                            <a href="#" class="brand-logo">
                                <svg
                                        viewbox="0 0 139 95"
                            ...
                            <form class="auth-reset-password-form mt-2"
                                  action="https://pixinvent.com/demo/vuexy-html-bootstrap-admin-template/html/ltr/vertical-menu-template/page-auth-login-v1.html"
                                  method="POST">
                                <div class="mb-1">
                            ...
                            <p class="text-center mt-2">
                                <a id="btn-back-send"> <i data-feather="chevron-left"></i> Back to send email
                                </a>
                            </p>
                        </div>
                    </div>
...
<script>
    ...
    $(document).on('click', '#btn-verification', function () {
        ...
        if ($('#forgot-email').val().trim() == "") {
            ...
            $('#forgot-email').parent().next().html('Please enter a valid email address!');
        } else {
            $('#forgot-email').css('border-color', 'lightgrey');
            $('#forgot-email').parent().next().html('');
            $('#form-forgot-email').addClass('hidden');
            $('#form-check').removeClass('hidden');
            var email = $('#forgot-email').val();
            $.ajax({
                url: '/_admin/forgot-Password/' + email,
                type: 'GET',
    ...
    $(document).on('click', '#btn-back-send-mail', function () {
        $('#form-check').addClass('hidden');
        $('#form-forgot-email').removeClass('hidden');
    })
    ...
    $(document).on('click', '#send-verification', function () {
        ...
        if ($('#verification').val().trim() == "") {
            ...
            $('#verification').parent().next().html('Please enter a valid Verification!');
        } else {
            var code = $('#verification').val();
            $.ajax({
                url: '/_admin/forgot-Password/code/' + code,
                type: 'GET',
                // contentType: "application/json",
                data: code
            }).done(function (data) {
            ...
            if(checkCode == true){
                $('#verification').css('border-color', 'lightgrey');
                $('#verification').parent().next().html('');
                $('#form-check').addClass('hidden');
                $('#reset-password-form').removeClass('hidden');

            }else {
                $('#verification').css('border-color', 'Red');
                $('#verification').parent().next().html('Confirmation code is incorrect!');
            }
        }
    })

    $(document).on('click', '#btn-back-send', function () {
...
<!-- Mirrored from pixinvent.com/demo/vuexy-html-bootstrap-admin-template/html/ltr/vertical-menu-template/page-auth-forgot-password-v1.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 25 Aug 2021 02:09:58 GMT -->
</html>